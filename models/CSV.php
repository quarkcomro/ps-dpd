...
class DpdGeopostCSV extends DpdGeopostObjectModel
{
	...
	public static $definition = array(
		...
		'fields' => array(
			...
			'region'					=>	array('type' => self::TYPE_STRING, 'validate' => 'isGenericName'),
			'zip'						=>	array('type' => self::TYPE_STRING, 'validate' => 'isGenericName'),
			'weight_from'				=>	array('type' => self::TYPE_STRING, 'validate' => 'isGenericName'),
			'weight_to'					=>	array('type' => self::TYPE_STRING, 'validate' => 'isGenericName'),
			'shipping_price'			=>	array('type' => self::TYPE_STRING, 'validate' => 'isGenericName'),
			'shipping_price_percentage'	=>	array('type' => self::TYPE_STRING, 'validate' => 'isGenericName'),
			'currency'					=>	array('type' => self::TYPE_STRING, 'validate' => 'isGenericName'),
			'method_id'					=>	array('type' => self::TYPE_STRING, 'validate' => 'isGenericName'),
			'cod_surcharge'				=>	array('type' => self::TYPE_STRING, 'validate' => 'isGenericName'),
			'cod_surcharge_percentage'	=>	array('type' => self::TYPE_STRING, 'validate' => 'isGenericName'),
			'cod_min_surcharge'			=>	array('type' => self::TYPE_STRING, 'validate' => 'isGenericName'),
