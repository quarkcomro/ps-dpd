$(document).ready(function(){
    function init_normalization_form() {
        ...
        function filterPickupOffice() {
            ...
            if (!AJAX_URL || officeSelect.length === 0 || cityField.length === 0 || countryField.length === 0) {
                return;
            }
            ...
            var url = AJAX_URL + '?filterCity=' + encodeURIComponent(selectedCity) + '&filterCountry=' + encodeURIComponent(selectedCountry);
            officeSelect.attr('disabled', 'disabled');
            officeSelect.html('...');
        ...
        function getCurrentAddress() {
            ...
            return {
                ...
                'state': $.trim($('.dpd-normalizer:visible .dpd_confirm_region').val()),
