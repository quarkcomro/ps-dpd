$(document).ready(function () {
    ...
    var dpdAjaxUrl = window._DPD_GLOBAL_AJAX_ || window._DPDGEOPOST_AJAX_URI_ || (typeof dpd_geopost_ajax_uri !== 'undefined' ? dpd_geopost_ajax_uri : '/modules/dpdgeopost/dpdgeopost.ajax.php');
    ...
    if($('#address_form').length > 0) {
        ...
        $('#address_form_check_btn').click(function(e){
            ...
            var url = dpdAjaxUrl + "?token=" + encodeURIComponent(dpd_token) + "&action=admin_change_address";
