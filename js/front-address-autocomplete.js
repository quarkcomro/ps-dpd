...
$(document).ready(function () {
    ...
    var dpdAjaxUrl = window._DPDGEOPOST_AJAX_URI_ || window._DPD_GLOBAL_AJAX_ || (typeof dpd_geopost_ajax_uri !== 'undefined' ? dpd_geopost_ajax_uri : ((window.baseUri || '/') + 'modules/dpdgeopost/dpdgeopost.ajax.php'));
    if(addressForm){
        ...
        if(postcodeField){
            ...
            $( postcodeField ).autocomplete(dpdAjaxUrl, {
