							...
							<span style="float: left;">
								{if $page > 1}
									<a href="{$saveAction|escape:'htmlall':'UTF-8'}&current_page=1&pagination={$selected_pagination|escape:'htmlall':'UTF-8'}">
										<img class="pagination_image" src="{$smarty.const._PS_IMG_|escape:'htmlall':'UTF-8'}admin/list-prev2.gif" alt="{l s='First page' mod='dpdgeopost'}" />
									</a>
									<a href="{$saveAction|escape:'htmlall':'UTF-8'}&current_page={$page|escape:'htmlall':'UTF-8' - 1}&pagination={$selected_pagination|escape:'htmlall':'UTF-8'}">
										<img class="pagination_image" src="{$smarty.const._PS_IMG_|escape:'htmlall':'UTF-8'}admin/list-prev.gif" alt="{l s='Previous page' mod='dpdgeopost'}" />
									</a>
								{/if}
								{l s='Page' mod='dpdgeopost'} <b>{$page|escape:'htmlall':'UTF-8'}</b> / {$total_pages|escape:'htmlall':'UTF-8'}
								{if $page < $total_pages}
									<a href="{$saveAction|escape:'htmlall':'UTF-8'}&current_page={$page|escape:'htmlall':'UTF-8' + 1}&pagination={$selected_pagination|escape:'htmlall':'UTF-8'}">
										<img class="pagination_image" src="{$smarty.const._PS_IMG_|escape:'htmlall':'UTF-8'}admin/list-next.gif" alt="{l s='Next page' mod='dpdgeopost'}" />
									</a>
									<a href="{$saveAction|escape:'htmlall':'UTF-8'}&current_page={$total_pages|escape:'htmlall':'UTF-8'}&pagination={$selected_pagination|escape:'htmlall':'UTF-8'}">
										<img class="pagination_image" src="{$smarty.const._PS_IMG_|escape:'htmlall':'UTF-8'}admin/list-next2.gif" alt="{l s='Last page' mod='dpdgeopost'}" />
									</a>
								{/if}
